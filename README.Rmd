...
The `statuses_to_approve` comma-separated list of
statuses subject to approve. See the notes below on which interview
statuses are currently allowed.
...
-   Open RStudio
-   Open the file `approve_reject_interviews.Rproj`, which will have the effect of
